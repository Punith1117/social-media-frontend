...
export const AuthContainer = styled.div`
  ...
  padding: 1rem;
  background: 
    radial-gradient(ellipse at top, rgba(59, 130, 246, 0.08) 0%, rgba(59, 130, 246, 0.04) 50%, transparent 70%),
...
export const SuccessMessage = styled.div`
  ...
  padding: 0.75rem;
  background: 
    linear-gradient(135deg, rgba(40, 167, 69, 0.12) 0%, rgba(34, 139, 34, 0.08) 100%),
    radial-gradient(circle at top right, rgba(40, 167, 69, 0.1) 0%, transparent 50%);
